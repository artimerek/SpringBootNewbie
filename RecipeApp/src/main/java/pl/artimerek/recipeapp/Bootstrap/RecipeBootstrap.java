...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        pancakeNotes.setRecipe(pancake);
        pancake.setNotes(pancakeNotes);

        pancake.getIngredients().add(new Ingredient("flour",new BigDecimal(125),gramsUom,pancake));
        pancake.getIngredients().add(new Ingredient("salt",new BigDecimal(1),teapoonUom,pancake));
        pancake.getIngredients().add(new Ingredient("egg",new BigDecimal(1),eachUom,pancake));
        pancake.getIngredients().add(new Ingredient("milk",new BigDecimal(330),miliUom,pancake));
        pancake.getIngredients().add(new Ingredient("butter",new BigDecimal(1),tableSpoonUom,pancake));
        pancake.getIngredients().add(new Ingredient("sugar",new BigDecimal(1),teapoonUom,pancake));
